...
- `trading-storage-dashboard-read-model-refresh.service` — oneshot refresh of the storage-hosted public dashboard read-model set: `current_system_status_summary`, `historical_task_progress_summary`, `realtime_signal_summary`, and `execution_realtime_trading_runtime_status`.
