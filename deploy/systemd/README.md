...
- `trading-storage-maintenance.service` — oneshot storage-owned maintenance runner. It currently applies local retention for storage-owned runtime roots, including timed log archive/delete behavior.
