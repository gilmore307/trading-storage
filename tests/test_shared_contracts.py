...
class SharedContractTests(unittest.TestCase):
    def test_target_layer2_context_mapping_keeps_crypto_proxies_out_of_layer_context(self):
        mapping_path = SHARED_ROOT / "model_02_target_context_mapping.csv"
        universe_path = SHARED_ROOT / "model_01_background_context_etf_universe.csv"
        combinations_path = SHARED_ROOT / "model_01_background_context_relative_strength_combinations.csv"
