...
- `test_dashboard_refresh.py` verifies storage-owned refresh orchestration from semantic producer output into `storage/dashboard_cache`, including no provider/model/broker/account side-effect flags.
