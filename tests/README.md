...
- `test_artifact_index.py` verifies conservative filesystem artifact indexing, M01/M02 foundation versus runtime/log classification, replay summary/input/download classification, explicit lifecycle metadata classification, explicit dashboard read-model indexing, and JSONL/summary writes.
