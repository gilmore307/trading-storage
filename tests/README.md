...
- `test_dashboard_snapshot_lifecycle.py` verifies dashboard snapshot metadata latest-only retention, dry-run/apply pruning, latest preservation, Layer 1/2/SQL non-mutation summary flags, and plan/summary output writes.
