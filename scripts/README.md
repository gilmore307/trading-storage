...
- `dashboard/refresh_event_calendar_summary_read_model.py` builds the event calendar summary from accepted SQL event rows and storage-local Trading Economics source evidence.
