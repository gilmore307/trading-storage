...
- `file_lifecycle_closeout.py` owns the one-pass safe file-lifecycle closeout over current index/protected-set/plan/quarantine/scaffold/compression/dashboard-prune helpers.
