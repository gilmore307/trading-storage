...
REPLAY_OPERATION_COMPONENTS = (
    ...
    ("component_04_expression_review", "C04 Expression Review"),
...
REPLAY_OPERATION_COMPONENT_ALIASES = {
    ...
    "component_04_expression_review": "component_04_expression_review",
    ...
    "c04_expression_review_operation": "component_04_expression_review",
    ...
    "component_04_expression_review_operation": "component_04_expression_review",
...
def _review_layer_decision_row(row: Mapping[str, Any], layer_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "review_boundary_ref": row.get("review_boundary_ref") or row.get("selected_output_ref") or row.get("candidate_set_scope"),
        "review_boundary_status": row.get("review_boundary_status") or "received_boundary_legacy_unspecified",
        "upstream_decision_state_policy": row.get("upstream_decision_state_policy")
        or "received_upstream_state_is_fixed_review_input",
        "downstream_review_input_policy": row.get("downstream_review_input_policy")
        or "judge_layer_only_against_received_decision_time_inputs",
        "upstream_error_isolation_scope": row.get("upstream_error_isolation_scope")
        or "attribute_upstream_defects_to_earliest_layer_or_boundary",
        "responsibility_assignment_policy": row.get("responsibility_assignment_policy")
        or "layer_local_correctness_given_received_inputs",
