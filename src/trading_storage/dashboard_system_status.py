...
def _dashboard_source_outputs(*, storage_root: Path, manager_storage_root: Path, now_epoch: float) -> list[dict[str, Any]]:
    ...
    output_specs: list[tuple[str, str, Path | None, str, str]] = [
        ...
        (
            ...
            storage_root / "06_dashboard_cache/read_models/current_system_status_summary.json",
            "heartbeat",
            dashboard_note,
        ),
        (
            ...
            storage_root / "06_dashboard_cache/read_models/historical_task_progress_summary.json",
            "heartbeat",
            dashboard_note,
        ),
        (
            ...
            storage_root / "06_dashboard_cache/read_models/realtime_signal_summary.json",
            "heartbeat",
            dashboard_note,
        ),
        (
