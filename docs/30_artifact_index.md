...
- `ttl_delete_allowed`: regenerable scratch, cache, dashboard snapshots, and later-layer model-run metadata that may be deleted after TTL/quarantine/run-cycle closure;
