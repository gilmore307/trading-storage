...
- Maintain storage-hosted dashboard read models for the current public set: `current_system_status_summary`, `historical_task_progress_summary`, `temporal_explorer_summary`, `realtime_signal_summary`, and `execution_realtime_trading_runtime_status`.
