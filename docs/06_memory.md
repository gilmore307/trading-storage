...
- For historical `trading-data` tasks, storage should own SQL output destination contracts and durable completion receipt storage/reference formats; it must not own provider semantics or manager lifecycle.
