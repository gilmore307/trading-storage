...
- Keep lifecycle execution dry-run-only until quarantine-before-delete and lifecycle receipts are implemented and reviewed. The V0.1 filesystem artifact index, protected-set builder, and durable-artifact lifecycle planner are implemented for inventory/safety/planning evidence only; they do not authorize production mutation.
