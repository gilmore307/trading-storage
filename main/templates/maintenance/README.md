...
The helper is conservative: it retains durable numbered storage roots, archives logs/runs/outputs before removing active copies, and deletes only clearly disposable temporary files or aged local archives.
