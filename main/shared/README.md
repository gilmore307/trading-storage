...
- `market_regime_relative_strength_combinations.csv` — curated Layer 1 V1 relative-strength combinations. Each row defines `numerator_symbol / denominator_symbol`, its group, intended feature cadence, source bar grains, and interpretation. The file is a reviewed planning/contract surface for `trading-derived`; generated feature values do not belong here.
